package com.andigital.store.repository;

import com.andigital.store.StoreApp;
import com.andigital.store.config.Constants;
import com.andigital.store.config.audit.AuditEventConverter;
...
import static com.andigital.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
